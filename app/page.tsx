          ...
          <div className="grid gap-8 lg:grid-cols-[1.35fr_.65fr] lg:items-end">
            <div className="max-w-3xl">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="/offres"
                  className="inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-purple-600 to-pink-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-purple-900/40 hover:from-purple-500 hover:to-pink-500 transition-all"
                >
        ...
        <section className="mt-8 grid grid-cols-1 gap-5 rounded-4xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl md:grid-cols-2">
          ...
          <div className="md:col-span-2">
            <button
              ...
              disabled={chargement}
              className="rounded-2xl bg-linear-to-r from-emerald-400 to-teal-300 px-6 py-3 font-semibold text-slate-950 shadow-lg shadow-emerald-500/20 transition hover:brightness-110 disabled:opacity-50"
            >
