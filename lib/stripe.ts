...
const CREDIT_PACKS: Record<string, CreditPackDefinition> = {
  starter: {
    ...
    credits: 100,
    amount: 100,
    description: "100 crédits Rudyo, soit 1 € au tarif unifié.",
  },
  creator: {
    id: "creator",
    name: "Creator",
    credits: 500,
    amount: 500,
    description: "500 crédits Rudyo, soit 5 € au tarif unifié.",
  },
  pro: {
    id: "pro",
    name: "Pro",
    credits: 1500,
    amount: 1500,
    description: "1 500 crédits Rudyo, soit 15 € au tarif unifié.",
  },
  tiktok_clip_complete: {
    id: "tiktok_clip_complete",
    name: "Pack Clip TikTok complet",
    credits: 3500,
    amount: 3500,
    description: "Créez un clip TikTok vertical allant jusqu’à 3 min 30 pour 35 € maximum, sans abonnement obligatoire.",
  },
};
